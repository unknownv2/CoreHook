...
public static class HookFactory
{
    ...
    public static IHook CreateHook(nint targetFunction, Delegate detourFunction, object callback)
    {
    ...
    /// <param name="callback">A context object that can be accessed as <see cref="HookRuntimeInfo.Callback"/> by the detour function.</param>
    /// <returns>The handle to the function hook.</returns>
    public static IHook<TDelegate> CreateHook<TDelegate>(nint targetFunction, TDelegate detourFunction, object callback = null) where TDelegate : class
    {
    ...
    /// <returns>The handle to the function hook.</returns>
    public static IHook CreateHook(nint targetFunction, nint detourFunction, nint? callback = null)
    {
        return LocalHook.CreateUnmanaged(targetFunction, detourFunction, callback ?? nint.Zero);
    }
    ...
    /// <param name="callback">An object that is associated with the hook and can be accessed by the detour function.</param>
    /// <returns>The handle to the function hook.</returns>
    public static IHook<TDelegate> CreateHook<TDelegate>(nint targetFunction, nint detourFunction, nint? callback = null) where TDelegate : class
    {
        return LocalHook<TDelegate>.CreateUnmanaged(targetFunction, detourFunction, callback ?? nint.Zero);
    }
}
